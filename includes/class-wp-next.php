...
class WP_Next {
	...
	public function __construct() {
		if ( defined( 'WP_NEXT_VERSION' ) ) {
			$this->version = WP_NEXT_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'wp-next';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wp-next-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wp-next-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-wp-next-admin.php';
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new WP_Next_Admin( $this->get_plugin_name(), $this->get_version() );
